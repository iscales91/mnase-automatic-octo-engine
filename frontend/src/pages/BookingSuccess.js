...
function BookingSuccess() {
  ...
  const pollPaymentStatus = async () => {
    ...
    try {
      ...
      const response = await axios.get(`${API}/bookings/status/${sessionId}`, { headers });
          ...
          <CardContent style={{ textAlign: 'center' }}>
            ...
            {status === 'success' && (
              <div data-testid="success-status">
                ...
                <p style={{ color: '#64748b', marginBottom: '2rem' }}>Your facility booking has been confirmed. Check your dashboard for details.</p>
                <Button asChild data-testid="view-bookings-btn">
            ...
            {(status === 'failed' || status === 'timeout' || status === 'error') && (
              <div data-testid="failed-status">
                ...
                <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
                  <Button asChild variant="outline" data-testid="back-to-facilities-btn">
